...
<div class="max-[600px]:bg-sky-300 min-[320px]:text-center">
 <form className="form">
      ...
      <div className="inputForm">
        ...
        <input placeholder="Digite seu email" className="input" type="text" />
      </div>
      ...
      <div className="inputForm">
        ...
        <input placeholder="Digite sua senha" className="input" type="password" />
      </div>
      ...
      <p className="p">
        Não tem conta? <span className="span">Cadastre-se</span>
      </p>
      <p className="p line">Ou também</p>
