...
export default function AlunoVagas() {
  ...
  // Busca vaga e relacionadas
  useEffect(() => {
    if (vagaId) {
      const vagaSelecionada = vagasFake.find(v => v.id.toString() === vagaId)
      setVaga(vagaSelecionada)

      const relacionadasFiltradas = vagasFake.filter(
    ...
    <div className="Aluno">
      <div className="container mt-4">
        ...
        {aluno ? (
          <div className="card p-3 mb-4">
            ...
            <form onSubmit={handleSubmit} encType="multipart/form-data">
              ...
              <button type="submit" className="btn btn mt-3">Inscrever-se</button>
            </form>
        ...
        {relacionadas.length === 0 ? (
          <h1>Desculpe! Não temos vagas relacionadas no momento</h1>
        ) : (
          <>
            <h1>Vagas Relacionadas</h1>
